...
export const HeaderHUD: React.FC<HeaderHUDProps> = ({ currentScene, totalDataCount, onRestart }) => {
  ...
  return (
    <header className="sticky top-0 w-full h-16 bg-slate-950/95 backdrop-blur-md border-b border-slate-800 px-4 sm:px-6 flex items-center justify-between text-white select-none z-50">
      {/* Brand Title */}
