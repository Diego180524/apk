...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-950 font-sans text-slate-100 flex flex-col antialiased select-none overflow-x-hidden">
      <HeaderHUD
      ...
      <main id="main-content-container" className="flex-1 w-full relative">
