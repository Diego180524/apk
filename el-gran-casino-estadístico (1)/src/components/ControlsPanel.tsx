...
import { Play, FastForward, RotateCcw, Zap, Clock, Disc, Layers, Dices } from 'lucide-react';
...
export const ControlsPanel: React.FC<ControlsPanelProps> = ({
  ...
  return (
    <div className="bg-slate-900 rounded-2xl p-4 sm:p-5 shadow-2xl border border-amber-500/30 text-white space-y-4">
      ...
      {/* Probability Bias Control Slider */}
      <div className="bg-slate-950/70 p-3 rounded-xl border border-slate-800 flex flex-wrap items-center justify-between gap-2 text-xs">
        <div className="flex items-center space-x-2 text-slate-300 font-bold">
          <Layers className="w-4 h-4 text-purple-400" />
          <span>Probabilidad p (Dirección):</span>
          <span className="bg-purple-950 text-purple-300 font-extrabold px-2 py-0.5 rounded-md border border-purple-700/50">
        ...
        <div className="flex items-center space-x-2 w-full sm:w-48">
          <span className="text-[10px] text-slate-500 font-bold">0.1</span>
          <input
            type="range"
            min="0.1"
            max="0.9"
          ...
          />
          <span className="text-[10px] text-slate-500 font-bold">0.9</span>
        </div>
      </div>
